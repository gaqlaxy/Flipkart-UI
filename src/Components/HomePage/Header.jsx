  ...
  return (
    <>
      <header className="flex items-center  justify-evenly  py-4 relative">
        ...
        <div
          className="flex gap-1 items-center profile relative hover:bg-stone-100 rounded border-stone-500 py-2 px-2"
...
"
          ...
          {showProfileDropdown && (
            <div className="absolute top-[40px] left-0 w-[200px] z-10 bg-stone-50 ">
              <ul>
                <a
                  href=""
...
"
        ...
        <div
          className="cursor-pointer menu-header relative hover:bg-stone-100 rounded border-stone-500 px-2 py-2"
...
"
          ...
          />
          {showMenuDropdown && (
          <div className="absolute top-8 right-0 z-10 w-52 bg-stone-50 ">
            <ul>
              <a
                href=""
                className="flex gap-2 py-2 px-2 text-[14px] hover:bg-stone-100 transition-hover duration-300"
